                                ...
                                <div className="tab-content" id="myTabContent">
                                    ...
                                    <div className="tab-pane fade show active" id="profile" role="tabpanel"
                                        ...
                                        <div className="tabCont propertyList mtEight">
                                            ...
                                            <div class="agencyStateList mt-3">
                                                <div class="propertyListState propertyListScroll boxscroll4">
                                                    <ul className="noMarginPad listStyleNone">
                                                        <li class="listState responsive-15">
                                                            <div class="d-flex align-items-center ResponsiveFlexDiv">
                                                                    ...
                                                                    <div class="agencyLeftHeadermedia">
                                                                        <div class="media">
                                                                            ...
                                                                            <div class="media-body">
                                                                                <div class="d-flex align-items-top">
                                                                                    <div>
                                                                                        <a href="agencyDetail.html" className="mb-0"><h5 class="mt-0 fontSize16 font-weight700 colorBlue">Anaheim Housing Authority</h5></a>
                                                                                        <a href="agencyDetail.html"><p class="mb-0 mt-0 font-weight400 fontSize14 secondaryColor">2882 Tyler St El Monte, CA 91157</p></a>
                                                                                    </div>                                                    
                                                                        ...
                                                                        <div class="bottomInfo d-flex align-items-center itemWebsite">
                                                                            <div class="callBtn purpleText font-weight700 fontSize14 d-flex align-items-center justify-content-center">
                                                                                <i class="fas fa-phone-alt"></i><span>(626) 448-2699</span>
                                                                            </div>
                                                                ...
                                                                <div class="agencyStateListRight">
                                                                    <div class="itemWebsite">
                                                                        <h5 class="text-center fontSize14 colorBlue font-weight500 mb-0">Section 8 Voucher Low-Rent</h5>
                                                                    ...
                                                                    <div class="bottomInfo d-flex align-items-center itemMobile">
                                                                        <div class="callBtn lineBtnMobile purpleText font-weight700 d-flex align-items-center justify-content-center">
                                                                            <i class="fas fa-phone-alt"></i><span>(626) 448-26999</span>
                                                                        </div>
                                                                        <div class="availbity availbilityBtn fontSize16 font-weight700">
                                                                            Check Availability
                                                                        </div>
                                                                        <a href="#" class="ml-auto moreInfo brdrRadius4 fontSize16 transition itemWebsite">More Info</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
